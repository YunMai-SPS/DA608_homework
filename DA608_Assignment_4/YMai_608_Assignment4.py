...
g = g.map(sns.swarmplot,"day_diff", "Site", hue="swim", palette="swim",data=hudson)
...
test_freq.iplot(kind='bar', x="ave_diff", y="Site", orientation = 'h',text='Site',
             xTitle='Test Time Gap', yTitle='Hudson River Site',
             filename='cufflinks/q2-bar-chart')


# **Conlusion: sites have been tested most regularly?   have long gaps between tests? Pick out 5-10 sites and visually compare how regularly their water quality is tested.**

# In[341]:

timesub = hudson.loc[(rain.Site == 'Poughkeepsie Drinking Water Intake')| 
